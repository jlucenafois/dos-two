				...
				dualComponents: [
					{
						...
						dualText: {
							spanishText: {
								content: [{ text: "horse is caballo" }],
								box: "shape",
							},
							englishText: {
								content: [{ text: "lento is slow" }],
								box: "shape",
							},
						},
					},
				...
				dualComponents: [
					{
						...
						dualText: {
							spanishText: {
								content: [{ text: "dormir is sleep" }],
								box: "shape",
							},
							englishText: {
								content: [{ text: "tirar is throw" }],
								box: "shape",
							},
						},
					},
				...
				dualComponents: [
					{
						...
						dualText: {
							spanishText: {
								content: [{ text: '"¡Baila conmigo!\n¡Wepa!" dice mamá.' }],
								box: "shape",
							},
							englishText: {
								content: [{ text: '"Dance with me!\nWepa!" says Mom.' }],
								box: "shape",
							},
						},
					},
				...
				dualComponents: [
					{
						...
						dualText: {
							spanishText: {
								content: [{ text: 'Mamá sonríe.\n"Eres ambas, mi amor."' }],
								box: "shape",
							},
							englishText: {
								content: [{ text: 'Mom smiles.\n"You are both, my love."' }],
								box: "shape",
							},
						},
					},
