...
/* END-USER-IMPORTS */
type CardKey = "carrot_card" | "zanahoria_card" | "potato_card" | "papa_card" | "rice_card" | "arroz_card" |  "avocado_card" | "aquacate_card";
...
export default class MG_2 extends MG_Base {
	...
	editorCreate(): void {
        ...
        // unflipped 
        this.unflipped = this.add.image(737, 902, "unflipped");

		// unflipped_1
        this.unflipped_1 = this.add.image(737, 390, "unflipped");

		// unflipped_2
        this.unflipped_2 = this.add.image(737, 646, "unflipped");

		// unflipped_3
        this.unflipped_3 = this.add.image(993, 902, "unflipped");

		// unflipped_4
        this.unflipped_4 = this.add.image(993, 390, "unflipped");

		// unflipped_5
        this.unflipped_5 =this.add.image(1249, 646, "unflipped");

		// unflipped_6
        this.unflipped_6 = this.add.image(481, 646, "unflipped");

		// unflipped_7
        this.unflipped_7 = this.add.image(993, 646, "unflipped");

		// hover_unflipped
		this.hover_unflipped = this.add.image(993, 646, "hover_unflipped");
	...
	create() {
        ...
        // Play the audio
        this.sound.play("MemoryCards_English");
        ...
        setupMemoryGame() {
        const cards = ["carrot_card", "zanahoria_card", "potato_card", "papa_card", "rice_card", "arroz_card", "avocado_card", "aquacate_card"];
    ...
    checkMatch(cards: Phaser.GameObjects.Image[]) {
        ...
        const matchedPair: Record<CardKey, CardKey> = {
			// "carrot_card", "zanahoria_card", "potato_card", "papa_card", "rice_card", "arroz_card", "avocado_card", "aquacate_card"
            "carrot_card": "zanahoria_card",
            "potato_card": "papa_card",
            "rice_card": "arroz_card",
            "avocado_card": "aquacate_card",
			"zanahoria_card": "carrot_card",
            "papa_card": "potato_card",
            "arroz_card": "rice_card",
            "aquacate_card": "avocado_card",
        };
        ...
        if (matchedPair[key1] === key2 || matchedPair[key2] === key1) {
            ...
            // for each of 4 matches get progress bar to 100, for this start at 25_progress_bar_lg, 75_progress_bar_lg, 100_progress_bar_lg
            ...
            const progressIndex = Math.min(this.matchedPairs.size /2, 4);
    ...
    endGame() {
        ...
        const reward_eight = this.add.image(900,500, "reward_eight");
        reward_eight.setScale(0.7);
        reward_eight.setVisible(false);
        ...
        this.time.delayedCall(4000, () => {
            ...
            reward_eight.setVisible(true);
			this.playerWinCoins(150);
            this.time.delayedCall(4000, () => {
                catPointer.destroy();
                reward_eight.setVisible(false);
                // play or quit
